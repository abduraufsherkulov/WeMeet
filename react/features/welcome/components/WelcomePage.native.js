...
const CENTER_PHOTO = require('../../../../images/centerphoto.png');
                ...
                <View style = { _headerStyles.page }>
                    ...
                    <SafeAreaView style = { styles.roomContainer } >
                        <View style = { styles.joinControls } >
                            <View style={{justifyContent: 'center', alignItems: 'center', paddingTop: 50, paddingBottom: 20}}>
                                <Image source={CENTER_PHOTO} />
                            </View>
                            <View style={{justifyContent: 'center', alignItems: 'center', paddingBottom: 25}}>
                                <Text style={styles.topMessage}>{t('welcomepage.roomname')}</Text>
                            </View>
                            <TextInput
                                ...
                                placeholder = { t('welcomepage.enterToJoin') }
